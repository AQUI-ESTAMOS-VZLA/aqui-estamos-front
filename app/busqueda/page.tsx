  ...
  return (
    <main className="wrap">
      ...
      <div className="panel" style={{ textAlign: 'center', padding: '3rem 1.5rem' }}>
        ...
        <h1 style={{ marginBottom: '.5rem' }}>Todavía estamos trabajando en el registro</h1>
        <p className="section-sub" style={{ maxWidth: 460, margin: '0 auto' }}>
          La búsqueda de personas estará disponible muy pronto. Estamos construyendo esta
          herramienta con cuidado para que puedas encontrar a tus seres queridos. Gracias por tu
          paciencia.
        </p>
